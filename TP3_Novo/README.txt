...
Acesse o diretório do código fonte pelo terminal. Note que existe um arquivo Makefile. Execute o comando make no terminal para realizar a compilação e geração de executável.

O executável pode ser encontrado no subdiretório 
